...
def get_welcome_response():
    ...
    reprompt_text = "How are you feeling today."
...
def get_health_status_intent(intent, session):
    ...
    if 'Emotion' in intent['slots']:
        ...
        speech_output = "You are feeling, " + \
                        favorite_color + \
                        ", right."
        reprompt_text = "I didn't quite get that, please repeat!"
    else:
        speech_output = "I'm not sure how you are feeling. " \
                        "Please try again."
    ...
    card_title = "Welcome"
    speech_output = "That's good to hear!"
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Could you repeat that, please."
    should_end_session = False
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, reprompt_text, should_end_session))
